...
<body class="min-h-screen bg-slate-50 text-slate-800 font-sans antialiased">
  <div id="wrap" class="max-w-6xl mx-auto px-4 sm:px-6 py-8">
    <div class="flex justify-end items-center gap-2 mb-2">
      <label id="labelLanguage" class="text-sm font-medium text-slate-600">Language</label>
      <select id="langSelect" class="rounded-lg border border-slate-300 px-3 py-1.5 text-sm text-slate-800 focus:border-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-400 align-middle">
    ...
    <div id="chartWrap" class="mb-8">
      <h1 id="titleMain" class="text-xl font-semibold text-slate-800 tracking-tight"><a href="/" class="text-slate-800 hover:text-slate-600">AlleSchools</a> · School map: academic level × science focus</h1>
      <p id="subtitleMain" class="mt-1 text-sm text-slate-500">Data from DUO. X = academic strength, Y = science share. Dot size = graduation count. <strong id="schoolCount" class="font-medium text-slate-700">0</strong> schools shown.</p>
