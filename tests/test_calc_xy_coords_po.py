"""单元测试：calc_xy_coords_po（小学 X/Y 坐标计算）"""
import pytest
import calc_xy_coords_po as m
...
class TestGetWozForYear:
    ...
    def test_prefer_closer_year(self):
        ...
        result = m.get_woz_for_year(woz, [2020, 2022, 2023], "1234", 2021)
        assert result in (200.0, 300.0)
